    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-surface-900 px-4 relative overflow-hidden transition-colors duration-500">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-40 -right-40 w-96 h-96 bg-brand-500/10 dark:bg-brand-500/5 rounded-full blur-3xl animate-float" />
                <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-purple-500/10 dark:bg-purple-500/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '-3s' }} />
            ...
            <div className="w-full max-w-md animate-slide-up relative z-10">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-light dark:bg-white/5 mb-6 border border-brand-500/10 shadow-sm dark:shadow-none">
                        ...
                        <span className="text-xs font-semibold text-gray-600 dark:text-gray-400">Productivity made simple</span>
                    </div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2 font-medium">Log in to your dashboard to stay on track</p>
                </div>
                ...
                <p className="mt-8 text-center text-sm font-medium text-gray-500 dark:text-gray-400">
                    New here?{' '}
                    <Link to="/register" className="text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 font-bold transition-colors">
                        Create an account
                    </Link>
                </p>
            </div>
